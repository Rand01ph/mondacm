...
<div>
    <ul class="breadcrumb">
        ...
        <li><a
                href="<?php echo site_url($this->config->item('admin_folder') . 'category/form'); ?>"><?php echo $title; ?></a>
        </li>
    </ul>
</div>
<!--头部结束-->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio"> <input type="radio" id="type"
                                    ...
                                    ?>
                                                         name="type"
                                                         value="1"/> <?php echo lang('category_type_list'); ?>
                            </label>
                            ...
                            <label class="radio"> <input type="radio" id="type"
                                    ...
                                    ?>
                                                         name="type"
                                                         value="2"/> <?php echo lang('category_type_page'); ?>
                            </label>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio"> <input type="radio" id="status"
                                    ...
                                    ?>
                                                         name="status"
                                                         value="1"/> <?php echo lang('category_status_open'); ?>
                            </label>
                            ...
                            <label class="radio"> <input type="radio" id="status"
                                    ...
                                    ?>
                                                         name="status"
                                                         value="2"/> <?php echo lang('category_status_close'); ?>
                            </label>
                        </div>
                    </div>
                <?php endif; ?>
