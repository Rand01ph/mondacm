...
<div>
    <ul class="breadcrumb">
        <li>
            <a href="<?php echo site_url('main'); ?>"><?php echo lang('set_system'); ?></a><span
                class="divider">/</span>
        </li>
        <li>
            ...
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_web_name_span'); ?></span>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <label class="control-label"
                           for="statistical_code"><?php echo lang('set_web_statistical_code'); ?> </label>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_web_keywords_span'); ?></span>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_web_description_span'); ?></span>
                    </div>
                </div>
            ...
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_resources_span'); ?></span>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_css_span');
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_js_span');
                            echo str_replace('/', '', SITE_WEB_RESOURCES) . '/web/default';
                            echo lang('set_file');
                            echo lang('set_file_span');
                            ?> </span>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_img_span');
                            echo str_replace('/', '', SITE_WEB_RESOURCES) . '/web/default';
                            echo lang('set_file');
                            echo lang('set_file_span');
                            ?> </span>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_editor_span');
                            echo str_replace('/', '', SITE_WEB_RESOURCES) . '/web/default';
                            echo lang('set_file');
                            echo lang('set_file_span');
                            ?> </span>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_art_span');
                            echo str_replace('/', '', SITE_WEB_RESOURCES) . '/web/default';
                            echo lang('set_file');
                            echo lang('set_file_span');
                            ?> </span>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_valicode_span');
                            echo str_replace('/', '', SITE_WEB_RESOURCES) . '/web/default';
                            echo lang('set_file');
                            echo lang('set_file_span');
                            ?> </span>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_uploads_span');
                            echo str_replace('/', '', SITE_WEB_RESOURCES) . '/web/default';
                            echo lang('set_file');
                            echo lang('set_file_span');
                            ?></span>
    ...
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <fieldset>
                ...
                <div class="control-group">
                    <label class="control-label"
                           for="upload_image_size"><?php echo lang('set_upload_image_size'); ?></label>
                ...
                <div class="control-group">
                    <label class="control-label"
                           for="upload_flash_size"><?php echo lang('set_upload_flash_size'); ?> </label>
                ...
                <div class="control-group">
                    <label class="control-label"
                           for="upload_media_size"><?php echo lang('set_uploads_media_size'); ?></label>
                ...
                <div class="control-group">
                    <label class="control-label"
                           for="upload_file_size"><?php echo lang('set_uploads_file_size'); ?> </label>
    ...
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <fieldset>
                ...
                <div class="control-group">
                    <label class="control-label"
                           for="reg_agreement"><?php echo lang('set_web_reg_agreement'); ?></label>
    ...
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <fieldset>
                ...
                <div class="control-group">
                    <label class="control-label"
                           for="encryption_key_begin"><?php echo lang('set_encryption_key_begin'); ?></label>
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_encryption_key_begin_span'); ?></span>
                    </div>
                </div>

                <div class="control-group">
                    <label class="control-label"
                           for="encryption_key_end"><?php echo lang('set_encryption_key_end'); ?></label>
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <span class="help-inline"><i class="icon-star"
                                                     title="<?php echo lang('data_required'); ?>"></i><?php echo lang('set_encryption_key_end_span'); ?></span>
                    </div>
                </div>
