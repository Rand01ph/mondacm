...
<div>
    <ul class="breadcrumb">
        ...
        <li><a
                href="<?php echo site_url($this->config->item('admin_folder') . 'role/form'); ?>"><?php echo $title; ?></a>
        </li>
    </ul>
</div>
<!--头部结束-->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio"> <input type="radio" id="status"
                                    ...
                                    ?>
                                                         name="status"
                                                         value="1"/> <?php echo lang('role_status_open'); ?>
                            </label>
                            ...
                            <label class="radio"> <input type="radio" id="status"
                                    ...
                                    ?>
                                                         name="status"
                                                         value="2"/> <?php echo lang('role_status_close'); ?>
                            </label>
                        </div>
                    </div>
                <?php endif; ?>
                <table
                    ...
                    <tr>
                        <td style="text-align: center; vertical-align: middle;"><input
                                ...
                                onClick="power_click(this, <?php echo $data['id']; ?>);"/><?php echo $data['name']; ?><?php if (isset($data['children_datas'])): ?>
                                <span
        ...
        <?php if (isset($data['children_datas'])): foreach ($data['children_datas'] as $n => $child_data): ?>
                                ...
                                <div><?php endif; ?><input class="input_checkbox"
                                    ...
                                    <span class="help-inline"
                                          style="width: 80px;"><?php echo $child_data['name']; ?></span> <?php if (isset($child_data['last_one']) && $child_data['level'] != 1): ?>
