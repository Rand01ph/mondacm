    ...
    <div class="navbar-inner navbar-fixed-top">
        <div class="container-fluid">
            <a class="btn btn-navbar" data-toggle="collapse"
               data-target=".top-nav.nav-collapse,.sidebar-nav.nav-collapse"> <span class="icon-bar"></span> <span
            ...
            <div class="btn-group pull-right theme-container">
                <a class="btn dropdown-toggle" data-toggle="dropdown" href="#"> <i class="icon-tint"></i><span
                        class="hidden-phone"><?php echo lang('change_skin'); ?></span> <span class="caret"></span> </a>
                <ul class="dropdown-menu" id="themes">
                    <li>
                        <a data-value="cerulean" href="#"><i class="icon-blank"></i><?php echo lang('skin_cerulean'); ?>
                        </a>
                    </li>
                    <li>
                        <a data-value="classic" href="#"><i class="icon-blank"></i> <?php echo lang('skin_classic'); ?>
                        </a>
                    </li>

                    <li>
                        <a data-value="cyborg" href="#"><i class="icon-blank"></i> <?php echo lang('skin_cyborg'); ?>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a data-value="journal" href="#"><i class="icon-blank"></i> <?php echo lang('skin_journal'); ?>
                        </a>
                    </li>
                    <li>
                        <a data-value="simplex" href="#"><i class="icon-blank"></i> <?php echo lang('skin_simplex'); ?>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a data-value="spacelab" href="#"><i
                                class="icon-blank"></i> <?php echo lang('skin_spacelab'); ?></a>
                    </li>
                    <li>
                        <a data-value="united" href="#"><i class="icon-blank"></i> <?php echo lang('skin_united'); ?>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="btn-group pull-right">
                <a class="btn dropdown-toggle" data-toggle="dropdown" href="#"> <i class="icon-user"></i><span
                        class="hidden-phone"> <?php echo $this->_manager->username; ?></span> <span
                        class="caret"></span> </a>
                        ...
                        <?php foreach ($menu_data['sub_power'] as $sub_n => $sub_data): ?>
                            ...
                            <?php foreach ($sub_data['sub_power'] as $sub_sub_data): ?>
                                <li><a class="ajax-link"
                                       href="<?php echo site_url($this->config->item('admin_folder') . $sub_sub_data['url']); ?>"><i
                                            class="<?php echo $sub_sub_data['icon']; ?>"></i><span
                                            class="hidden-tablet"> <?php echo $sub_sub_data['name']; ?></span></a></li>
                            <?php endforeach; ?>
                        <?php endforeach; ?>
                    </ul>
                </div>
