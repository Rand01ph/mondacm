...
<div>
    <ul class="breadcrumb">
        ...
        <li><a
                href="<?php echo site_url($this->config->item('admin_folder') . 'mode/form'); ?>"><?php echo $title; ?></a>
        </li>
    </ul>
</div>
<!--头部结束-->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio"> <input type="radio" id="status"
                                    ...
                                    ?>
                                                         name="status"
                                                         value="1"/> <?php echo lang('mode_status_open'); ?>
                            </label>
                            ...
                            <label class="radio"> <input type="radio" id="status"
                                    ...
                                    ?>
                                                         name="status"
                                                         value="2"/> <?php echo lang('mode_status_close'); ?>
                            </label>
                        </div>
                    </div>
                <?php endif; ?>
