...
<div>
    <ul class="breadcrumb">
        ...
        <li><a
                href="<?php echo site_url($this->config->item('admin_folder') . 'manager/form'); ?>"><?php echo $title; ?></a>
        </li>
    </ul>
</div>
<!--头部结束-->
            ...
            <fieldset>
                ...
                <div class="control-group">
                    <label class="control-label"
                           for="password_confirm"><?php echo lang('manager_password_confirm'); ?></label>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="radio"> <input type="radio" id="phone_status"
                                ...
                                ?>
                                                     name="phone_status"
                                                     value="1"/><?php echo lang('phone_status_open_span'); ?>
                        </label>
                        ...
                        <label class="radio"> <input type="radio" id="phone_status"
                                ...
                                ?>
                                                     name="phone_status"
                                                     value="2"/> <?php echo lang('phone_status_close_span'); ?>
                        </label>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="radio"> <input type="radio" id="email_status"
                                ...
                                ?>
                                                     name="email_status"
                                                     value="1"/> <?php echo lang('email_status_open_span'); ?>
                        </label>
                        ...
                        <label class="radio"> <input type="radio" id="email_status"
                                ...
                                ?>
                                                     name="email_status"
                                                     value="2"/> <?php echo lang('email_status_close_span'); ?>
                        </label>
                    </div>
                </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio"> <input type="radio" id="status"
                                    ...
                                    ?>
                                                         name="status"
                                                         value="1"/> <?php echo lang('manager_status_open_span'); ?>
                            </label>
                            ...
                            <label class="radio"> <input type="radio" id="status"
                                    ...
                                    ?>
                                                         name="status"
                                                         value="2"/> <?php echo lang('manager_status_close_span'); ?>
                            </label>
                        </div>
                    </div>
                <?php endif; ?>
