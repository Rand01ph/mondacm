...
<div>
    <ul class="breadcrumb">
        ...
        <li><a
                href="<?php echo site_url($this->config->item('admin_folder') . 'power'); ?>"><?php echo $title; ?></a>
        </li>
    </ul>
</div>
<!--头部结束-->
                ...
                <?php if ($datas): ?>
                    <?php foreach ($datas as $n => $power_datas): ?>
                        <tr id="tr_power_<?php echo $power_datas['id']; ?>">
                            ...
                            <td class="power_left"
                                style="padding-left:<?php echo $power_datas['level'] * 24, 'px'; ?>;">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if ($power_datas['icon']): ?> <i
                                    class="<?php echo $power_datas['icon']; ?>"></i><?php endif; ?><?php echo $power_datas['name']; ?>
                            </td>
