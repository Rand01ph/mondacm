...
<div>
    <ul class="breadcrumb">
        ...
        <li><a
                href="<?php echo site_url($this->config->item('admin_folder') . 'link/form'); ?>"><?php echo $title; ?></a>
        </li>
    </ul>
</div>
<!--头部结束-->
            ...
            <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio"> <input type="radio" id="status"
                                    ...
                                    ?>
                                                         name="status"
                                                         value="1"/> <?php echo lang('link_status_open'); ?>
                            </label>
                            ...
                            <label class="radio"> <input type="radio" id="status"
                                    ...
                                    ?>
                                                         name="status"
                                                         value="2"/> <?php echo lang('link_status_close'); ?>
                            </label>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <img class="grayscale"
                             src="<?php echo $link_thumb != null ? $link_thumb : '/assets/admin/default/img/nopic.gif'; ?>"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="button" class="btn" onclick="unsetThumb('thumb','imgthumb')"
                               value="<?php echo lang('link_nopic_btn_span'); ?>"/>
                    </div>
                </div>
